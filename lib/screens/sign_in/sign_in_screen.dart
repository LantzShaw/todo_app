          ...
          Row(
            ...
            children: <Widget>[
              TextButton(
                ...
                child:Text('注册账户', style: TextStyle(color: Color.fromARGB(255, 122, 121, 121))),
                onPressed: () => {
              ...
              TextButton(
                ...
                child: Text('手机号登录', style: TextStyle(color: Color.fromARGB(255, 122, 121, 121))),
                onPressed: () => {
                  Get.toNamed('/signUp')
                }
              ),
              TextButton(
                ...
                child: Text('找回密码', style: TextStyle(color: Color.fromARGB(255, 122, 121, 121))),
                onPressed: () => {
                  Get.toNamed('/signUp')
                }
              ),
